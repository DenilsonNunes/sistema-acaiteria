...
const ResumoTotaisPedido = () => {
  ...
  const { orderEdit } = usePedidoStore();
    ...
    <section>
      ...
      <div className="bg-gray-300 rounded-lg py-2 px-4 sm:py-4">
        ...
        <div className="flex justify-between">
          <p>SubTotal</p>
          <p className="font-medium">R$ {formatarMoedaBRL(orderEdit.valorTotalCart)}</p>
        </div>
      ...
      <div className="flex justify-between bg-gray-300 rounded-lg py-2 px-4 sm:py-4">
        ...
        <div className='flex items-center gap-1'>
          <p>R$</p>
          <p className="font-bold text-2xl">{formatarMoedaBRL(orderEdit.valorTotalCart)}</p>
        </div>
      </div>
