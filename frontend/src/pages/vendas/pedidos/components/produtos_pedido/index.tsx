...
const ProdutosPedido = () => {
  ...
  const {orderEdit, adicionarItemPedido, diminuirQtdItemPedido, selecionarItemParaEditar, removerItemPedido} = usePedidoStore();
  ...
  return (
    ...
    <section>
      ...
      {orderEdit.itens.map((item, index) => (
        ...
        <div key={index} className="w-full mb-4 flex flex-col bg-gray-100 border border-gray-300 p-2 rounded-lg">
          ...
          <div className='flex justify-between'>
            ...
            <div>
              ...
              {orderEdit?.itens?.length > 1 && (
                <button className='text-red-500  cursor-pointer'>
                  <Trash2 size={26} onClick={()=> removerItemPedido(item.uuid)}/>
                </button>
              )}
