...
interface DataTableProps<TData, TValue> {
  ...
  isError?: boolean;
  limitPerPage: string
  onChangeLimitPerPage: (value: string) => void

} 

export function DataTableCustomer<TData, TValue>({columns, data, isLoading, isError, limitPerPage, onChangeLimitPerPage}: DataTableProps<TData, TValue>) {
  ...
  return (
    <div className="w-full">
      ...
      <div className="flex gap-4 mb-4">
        ...
        <Input
          placeholder="Pesquise pelo cliente ou apelido"
          value={
      ...
      <div className="rounded-md border">
        ...
        <div className="flex justify-between m-2">
          ...
          <div className="flex gap-2 items-center">
            ...
            <p className="text-sm">Resultados por página</p>

            <ResultPage value={limitPerPage} onChange={onChangeLimitPerPage}/>
